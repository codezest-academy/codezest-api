...
- **Database**: Prisma client, database connection logic.
- **Repositories**: Concrete implementations of the interfaces defined in `src/domain`. This is where the actual database calls happen.
